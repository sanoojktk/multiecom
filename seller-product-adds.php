                                ...
                                <div class="modal-body">
                                    <div class="login-form">
                                      ...
                                      <input type="input" class="form-control" id="name"
                                       placeholder="Enter your Product Name" name="prod_name">
                                                        <i class="clear-input">
                                                    ...
                                                    <div class="input-wrapper">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <input type="input" name="quantity" class="form-control" id="quan">
                                                                <i class="clear-input">
                                                                    <ion-icon name="close-circle"></ion-icon>
                                                                </i>
                                                            </div>
                                                            <div class="col">
                                                                ...
                                                                <select class="form-control form-select" id="unit" name="qunit">
...
<?php
$sql="SELECT * FROM cate_gory WHERE seller_id='$seller_id'";
...
<?php
$sqi="SELECT prod_id,prod_name,prod_image,discount_price,seller_ids FROM pro_details WHERE seller_ids='$seller_id' ORDER BY prod_id  DESC";
...
?>                             
                            <li>
                                <div class="item">
                                    <div class="item" onclick="document.location='seller-product-edit.php'">
                                        <div class="imageWrapper">
                                            <img src="prod_image/<?php echo $row['prod_image'];?>" alt="image" class="imaged w64">
                                        </div>
                                        <div>
                                            <?php echo $row['prod_name'];?>
                                            <div class="text-muted"><?php echo $row['discount_price'];?></div>
                                        </div>
                                    </div>
                                    <div style="padding:15px" data-bs-toggle="modal"
