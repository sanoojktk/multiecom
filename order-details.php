                        ...
                        <div class="section full">
                            <div class="invoice">
                                <div class="invoice-page-header">
                                    ...
                                    <!-- Button to be displayed acording to the status from database -->
                                    <!-- <button style="padding-top: 15px;" type="button"
                                                        class="btn btn-text-success">DELIVERED</button>
                                                    <button style="padding-top: 15px;" type="button"
                                                        class="btn btn-text-danger">REJECTED</button> -->
                                    <button style="padding-top: 15px;" type="button"
                                        class="btn btn-text-warning">PENDING</button>
                                </div>
                                <div class="invoice-page-header">
