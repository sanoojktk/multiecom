...
<body>
   ...
   <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">Delivery Option</div>
 ...
 <div class="section mt-3 mb-3">
            <div class="card">
                ...
                <form action="controller/middleware.php" method="post">
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                           
              <label class="form-check-label" for="radio2">
        <input type="radio" class="form-check-input" id="radio2" name="optradio" value="pickup">&nbsp;PickuP
      </label>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
