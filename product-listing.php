...
?>
<div class="cart_div">
<a href="carts.php"><img src="assets/img/cart-icon.png" /> Cart<span><?php echo $cart_count; ?></span></a>
</div>
<?php
}
?>
...
$product_array = $db_handle->runQuery("SELECT * FROM pro_details
    WHERE  city_id LIKE '%{$cityid}%' AND prod_name LIKE '%{$prod_name}%'");
...
?>                 
                <div class="col-6">
                    <div class="card product-card">
                        ...
                        <div class="card-body">
<form method="post" 
action="product-listing.php?action=add&id=<?php echo $product_array[$key]["prod_id"];?>">
                            <img src="prod_image/<?php echo $product_array[$key]["prod_image"]; ?>" class="image" alt="product image">
                            <h2 class="title"><?php echo $product_array[$key]["prod_name"]; ?></h2>
                            <p class="text"></p>
                            <div class="price"><?php echo $product_array[$key]["discount_price"];?></div>

                           <div class="quantity"><input type="text" class="product-quantity" name="quantity" value="1" size="2" /></div>
